...
To generate in-text citations, you can use the `textcite'  and `parencite', depending on whether you want to embed a citation in the flow of a sentence or between parentheses:

\textcite{ccrintro} said: ``CCR is great'' \parencite[p.~1]{ccrintro}
